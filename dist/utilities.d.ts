...
export declare const getRandomColor: (number: number, colors: Array<string>, range: number) => string;
export declare const getContrast: (hexcolor: string) => "#000000" | "#FFFFFF";
