...
function generateColors(name, colors) {
    ...
    const elementsProperties = Array.from({ length: ELEMENTS }, (_, i) => ({
        ...
        translateX: (0, utilities_1.getUnit)(numFromName * (i + 1), SIZE / 10, 1),
        translateY: (0, utilities_1.getUnit)(numFromName * (i + 1), SIZE / 10, 2),
        scale: 1.2 + (0, utilities_1.getUnit)(numFromName * (i + 1), SIZE / 20) / 10,
        rotate: (0, utilities_1.getUnit)(numFromName * (i + 1), 360, 1),
    }));
    return elementsProperties;
}
const AvatarMarble = ({ name, colors, size, square }) => {
...
exports.default = AvatarMarble;
//# sourceMappingURL=avatarMarble.js.map