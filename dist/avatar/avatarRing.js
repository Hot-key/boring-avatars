...
function generateColors(name, colors) {
    ...
    const colorsShuffle = Array.from({ length: COLORS }, (_, i) => (0, utilities_1.getRandomColor)(numFromName + i, colors, range));
    const colorsList = [];
...
const AvatarRing = ({ name, colors, size, square }) => {
