...
function generateColors(name, colors) {
    ...
    const colorList = Array.from({ length: ELEMENTS }, (_, i) => (0, utilities_1.getRandomColor)(numFromName % i, colors, range));
    return colorList;
}
const AvatarPixel = ({ name, colors, size, square }) => {
...
exports.default = AvatarPixel;
//# sourceMappingURL=avatarPixel.js.map